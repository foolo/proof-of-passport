...
| Requirement | Version | Installation Guide |
|-------------|---------|--------------------|
| Java JDK    | 17      | [Install Java](https://www.oracle.com/java/technologies/downloads/#java17) |
...
To facilitate the installation of the SDK and NDK, and to pair with development devices with a conventient QR code, you can use Android Studio. Get the latest version at https://developer.android.com/studio
...
All of the commands below are run from the `proof-of-passport/app` directory
...
In Android Studio, you can use the Device Manager to pair with and connect to your phone.

To view the Android logs you can use Logcat in Android Studio, or use `adb logcat`.
...
To view the Android logs, use `adb logcat`
